...
![Example](https://raw.githubusercontent.com/duckietown/lib-dt-apriltags/daffy/test/test_files/test_image.png)
...
3. Write a python function `get_slopes_intercepts` that takes a list of lines as an input and returns a list of slopes and a list of intercepts.
   ...
   - `intercepts`: the list of x-intercepts
...
1. Write a python function `get_lane_center` that takes a list of lanes as an input and returns the center of the closest lane and its slope.
   The function should take the following parameters:
